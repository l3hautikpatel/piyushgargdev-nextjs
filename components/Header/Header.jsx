              ...
              <div className={`${classes.nav__right}`}>
                ...
                >
                  ...
                  <Link
                    ...
                    id="github-account"
                    className={`cursor-pointer text-[#ffffff]  transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiGithubFill />
                  </Link>
                  ...
                  <Link
                    ...
                    id="twitter-account"
                    className={`cursor-pointer text-[#ffffff] hover:text-[#1da1f2] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <NewTwitterLogo/>
                  </Link>
